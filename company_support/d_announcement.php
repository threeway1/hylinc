...
<main id="content-wrap" class="company-support"> <!-- 폴더별 클레스 -->
    ...
    <section class="d-announcement"><!-- 클레스 == 페이지명 -->
        <div class="container">
            ...
            <div class="section-content">
                <nav class="tab-menu">
                    <ul>
                        <li><a href="/company_support/development.php">소개</a></li>
                        <li class="active"><a href="/company_support/d_announcement.php">공고 및 접수</a></li>
                    </ul>
                </nav>
            </div>
        </div>
